...
class Solver(
    ...
    constructor(greenArr: Array<String>,y1Arr: Array<String>,y2Arr: Array<String>,y3Arr: Array<String>,greySt:String)
    :this( greenArr.toList(), y1Arr.toList(), y2Arr.toList(),y3Arr.toList(), greySt){
    }

    fun solve(numOfColumn: Int):String{
       ...
       return joinListColumns(words,numOfColumn)
    }
    ...
    fun solve(): List<List<String>> {
        ...
        if(g.isEmpty() && y1.isEmpty() && y2.isEmpty() && y3.isEmpty() && gray.isEmpty() ){
            numOfMatch = 0
            return words
        }
